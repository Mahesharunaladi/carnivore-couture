...
import { CartContext, CartProvider } from './context/CartContext'; // Import CartProvider here
...
function App() {
  ...
  // Wrap your main app content with CartProvider
  return (
    <AuthProvider>
      <CartProvider>
                ...
                <header className="main-header">
                  ...
                  <div className="header-actions">
                    <button className="cart-button" onClick={() => window.location.href='/cart'}>
                      <FiShoppingCart />
                      {cartItems.length > 0 && <span className="cart-badge">{cartItems.length}</span>} {/* Display cartItems.length */}
                    </button>
                  ...
                  <div className="product-grid">
                    {premiumFish.map((fish) => (
                      <div className="product-card" key={fish.id}>
                        ...
                        <div
                          className="add-btn"
                          onClick={() => addToCart(fish)} // Call addToCart with the fish object
                        >
                          +
                        </div>
                        <h3>{fish.name}</h3>
